	...
	public static void main(String[] args) throws Exception {
		...
		while(q-->0) {
			...
			if(type == 1 || type == 2) {
				...
				int x1 = t.readInt()-1,y1 = t.readInt()-1;
				int x2 = t.readInt()-1,y2 = t.readInt()-1;
				Integer xres = rows.ceiling(x1);
				Integer yres = cols.ceiling(y1);
				if((xres == null || xres>x2) || (yres == null || yres>y2)) sb.append("Yes\n");
				else sb.append("No\n");
			}
		}
