...
public class Problem {
	...
	public static void main(String[] args) throws Exception {
		...
		while(test-->0) {
			...
			for(int i = 0;i<n;i++)l.add(new Pair(t.readInt(),0));
			for(int i = 0;i<n;i++) l.get(i).y = t.readInt();
			
			
		
			
			Collections.sort(l,(aa,bb)->aa.x-bb.x);
			
			for(Pair it:l)sb.append(it.x+" ");
			sb.append("\n");
			for(Pair it:l)sb.append(it.y+" ");
			sb.append("\n");
		}
