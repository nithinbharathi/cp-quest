...
public class Problem {
	...
	public static void generate(String cur,int fours, int sevens){
		if(fours == sevens && cur.length()>0)l.add(cur);
		if(cur.length()>=11){			
			return;
		}
		generate(cur+"4",fours+1,sevens);
		generate(cur+"7",fours,sevens+1);
	}
