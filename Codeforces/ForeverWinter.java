...
/**
 * 
 * @submission : Nithin Bharathi 10-June-2023
 * 
 */
	...
	public static void main(String[] args) throws Exception{
		...
		while(test-->0){
			...
			for(int i = 0;i<1001;i++){
				if(cnt[i]>0)map.put(cnt[i], i);
			}
			if(map.size()>1)sb.append(map.get(map.firstKey())+" "+(map.get((map.lastKey()))-1));
			else sb.append(map.get(map.firstKey())+" "+(map.get(map.firstKey())-1));
			sb.append("\n");
